...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Pricing Center', href: '/pricing', icon: <DollarSign size={16} />, roles: ['super_admin'], section: 'Gestión' },
  { label: 'Historial precios', href: '/pricing/history', icon: <Receipt size={16} />, roles: ['super_admin'], section: 'Gestión' },
  { label: 'Márgenes', href: '/pricing/margins', icon: <TrendingUp size={16} />, roles: ['super_admin'], section: 'Gestión' },
