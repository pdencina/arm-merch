...
const cards = [
  {
    ...
    description: 'Vista ejecutiva consolidada para decisiones rápidas de ventas, campus, productos y operación.',
    href: '/dashboard',
    icon: BrainCircuit,
    tag: 'Global',
  },
  {
    title: 'Analytics',
    description: 'Reportes operacionales, filtros por fecha, vendedores, productos y exportación CSV.',
  ...
  {
    title: 'IA Insights',
    description: 'Lectura ejecutiva con IA sobre ventas, stock crítico, productos top y recomendaciones.',
  ...
  {
    title: 'Forecast',
    description: 'Proyección ejecutiva para anticipar demanda, inventario y comportamiento comercial.',
        ...
        <div className="relative flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-sm leading-7 text-zinc-400">
              Centro ejecutivo de ARM Merch para leer la operación, analizar indicadores,
              detectar oportunidades y tomar decisiones estratégicas sin buscar links módulo por módulo.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-zinc-800 bg-black/30 p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm font-black text-white">Ejecutivo global</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {cards.map((card) => {
          ...
          return (
            <Link
              key={card.title}
              href={card.href}
              className="group rounded-[28px] border border-zinc-800 bg-zinc-900 p-5 transition-all duration-200 hover:-translate-y-1 hover:border-amber-500/30 hover:bg-zinc-900/80 hover:shadow-[0_24px_70px_rgba(0,0,0,0.25)]"
            >
              <div className="mb-5 flex items-start justify-between">
                ...
                <span className="rounded-full border border-zinc-700 bg-zinc-950 px-3 py-1 text-[10px] font-black uppercase tracking-widest text-zinc-400">
                  {card.tag}
                </span>
              </div>
